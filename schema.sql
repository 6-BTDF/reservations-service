...
CREATE TABLE herkbath.listings (
  ...
  serviceFee NUMERIC(3,2) DEFAULT 10 NOT NULL CONSTRAINT positive_cleaningFee CHECK (serviceFee > 0),
...
ALTER TABLE bookings ADD FOREIGN KEY (id_listings) REFERENCES listings (id);
ALTER TABLE bookings ADD FOREIGN KEY (id_users) REFERENCES users (id);
