...
writeListings.write('id,dailyPrice,cleaningFee,serviceFee,taxes,weeklyDiscount,monthlyDiscount,weeklyPremium,holidayPremium,max_guests,min_stay,max_stay\n')
...
const reservationsGen = (listingsCounter, baseFee, tax) => {
  ...
  return `${currentId},${baseFee.toFixed(2)},${(baseFee * 0.5).toFixed(2)},${(baseFee * 0.125).toFixed(2)},${tax},${discount + 10},${discount + 15},${premium + 10},${premium + 15},${random(14) + 2},${random(3) + 1},${random(40) + 3}\n`;
};
